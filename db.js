    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    x = _a.sent();
                    return [4 /*yield*/, prisma.userState.findMany()];
                case 2:
                    y = _a.sent();
                    console.log(x.length, y.length);
                    return [4 /*yield*/, prisma.userAuth.deleteMany()];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, prisma.userState.deleteMany()];
                case 4:
                    _a.sent();
...
function get_db() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.userAuth.findMany()];
                case 1:
                    x = _a.sent();
                    return [4 /*yield*/, prisma.userState.findMany()];
                case 2:
